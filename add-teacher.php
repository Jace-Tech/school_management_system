                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div id="dropzone1" class="pro-ad">
                                                <form id="form" action="./handlers/teachers.php" method="post" enctype="multipart/form-data" id="demo1-upload">
                                                    <fieldset>
                                                        <legend class="text-primary">Teacher's Information</legend>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
